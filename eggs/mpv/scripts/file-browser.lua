...
state.keybinds = {
    ...
    {'l',           'down_dir',     down_dir},
    {'h',           'up_dir',       up_dir},
    {'j',           'scroll_down',  function() scroll(1, o.wrap) end,           {repeatable = true}},
    {'k',           'scroll_up',    function() scroll(-1, o.wrap) end,          {repeatable = true}},
    {'o',           'play',         function() open_file('replace', false) end},
...
-- mp.add_key_binding('Ctrl+e','browse-files', toggle)
mp.add_key_binding('Ctrl+Shift+e','open-browser', toggle)
